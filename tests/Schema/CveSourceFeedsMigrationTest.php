...
final class CveSourceFeedsMigrationTest extends TestCase
{
    ...
    public function testMigrationSeedsProductScopeIncludingMysql41HistoryAndAwsCloudProducts(): void
    {
        ...
        $this->assertStringContainsString("'percona_advisory', 'xtrabackup', 'Percona XtraBackup'", $this->migration);
        $this->assertStringContainsString("'percona_advisory', 'pmm', 'Percona Monitoring and Management'", $this->migration);
    }
