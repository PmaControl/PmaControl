...
echo '<th style="width: 10%">' . __('Label') . '</th>';
...
?>
<a href="<?= LINK ?>environment/add/NULL" role="button" class="btn btn-primary"><span
        class="glyphicon glyphicon-triangle-plus" aria-hidden="true"></span> Add environment</a>