...
if (!empty($data['variables'])) {
    foreach ($data['variables'] as $server => $var) {
        ...
        if (empty($variable['max_connections'])) {
            continue;
        }
        ...
        $totalmemorytest = $variable['key_buffer_size'] + $variable['query_cache_size'] + $variable['tmp_table_size'] + $variable['innodb_buffer_pool_size'] + $variable['innodb_additional_mem_pool_size']
            + $variable['innodb_log_buffer_size'] + $variable['max_connections'];

        $totalmemory = $variable['key_buffer_size'] + $variable['query_cache_size'] + $variable['tmp_table_size'] + $variable['innodb_buffer_pool_size'] + $variable['innodb_additional_mem_pool_size'] + $variable['innodb_log_buffer_size']
            + $variable['max_connections'] * ( $variable['sort_buffer_size'] + $variable['read_buffer_size'] + $variable['read_rnd_buffer_size'] + $variable['join_buffer_size'] + $variable['thread_stack']
        ...
        $totalmemoryused = $variable['key_buffer_size'] + $variable['query_cache_size'] + $variable['tmp_table_size'] + $variable['innodb_buffer_pool_size'] + $variable['innodb_additional_mem_pool_size']
            + $variable['innodb_log_buffer_size'] + $variable['max_used_connections'] * ( $variable['sort_buffer_size'] + $variable['read_buffer_size'] + $variable['read_rnd_buffer_size'] + $variable['join_buffer_size']
...
foreach ($data['variables'] as $server => $var) {
    ...
    if (!empty($mem_engine['innodb'])) {
        ...
        if ($innodb_mem > 0) {
            ...
            $parameter[] = "innodb_buffer_pool_chunk_size=".$innodb_buffer_pool_chunk_size." #with unit : ".getUnit($innodb_buffer_pool_chunk_size, true)." - before : ".getUnit($variable['innodb_buffer_pool_chunk_size'],
                    true);
    ...
    $parameter[] = "tmp_table_size       = 256M";
    $parameter[] = "max_heap_table_size  = 256M #moteur memory utilisé pour les tables temporaires";
    ...
    $totalmemorytest = $variable['key_buffer_size'] + $variable['query_cache_size'] + $variable['tmp_table_size'] + $variable['innodb_buffer_pool_size'] + $variable['innodb_additional_mem_pool_size'] + $variable['innodb_log_buffer_size']
    ...
    $totalmemoryused = $variable['key_buffer_size'] + $variable['query_cache_size'] + $variable['tmp_table_size'] + $variable['innodb_buffer_pool_size'] + $variable['innodb_additional_mem_pool_size'] + $variable['innodb_log_buffer_size']
        + $variable['max_used_connections'] * ( $variable['sort_buffer_size'] + $variable['read_buffer_size'] + $variable['read_rnd_buffer_size'] + $variable['join_buffer_size'] + $variable['thread_stack']
        + $variable['binlog_cache_size']
        );
