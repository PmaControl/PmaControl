...
/**
 * Class responsible for load2 workflows.
 *
...
/**
 * Handle load2 state through `exec`.
 *
...
/**
 * Handle load2 state through `waitPosition`.
 *
 * This action may stream a direct HTTP or CLI response.
 *
...
/**
 * Handle load2 state through `install`.
 *
...
/**
 * Handle load2 state through `log`.
 *
 * This action may stream a direct HTTP or CLI response.
 *
...
/**
 * Retrieve load2 state through `getLogAndPos`.
 *
 * This action may stream a direct HTTP or CLI response.
 *
...
/**
 * Handle load2 state through `cmd`.
 *
 * This action may stream a direct HTTP or CLI response.
 *
