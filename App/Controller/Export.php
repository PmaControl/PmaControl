...
class Export extends Controller
{
    ...
    var $table_with_data_expand = array("menu", "menu_group", "history_etat", "ts_file","ts_variable","tag",
        "group", "environment", "daemon_main", "version", "sharding", "ts_variable", "dot3_legend","worker_queue",
