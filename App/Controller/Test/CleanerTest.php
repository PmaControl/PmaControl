...
/**
 * Class responsible for cleaner test workflows.
 *
...
/**
 * Handle cleaner test state through `mydb`.
 *
 * This routine may read or mutate framework state, superglobals or persistence layers.
 *
 * @return mixed Returned value for mydb.
 * @phpstan-return mixed
 * @psalm-return mixed
 * @see self::mydb()
 * @example /fr/cleanertest/mydb
 * @category PmaControl
 * @package App
 * @subpackage Controller
 * @author Aurélien LEQUOY <pmacontrol@68koncept.com>
...
/**
 * Handle cleaner test state through `testPushAndPop`.
 *
 * This routine may read or mutate framework state, superglobals or persistence layers.
 *
 * @return void Returned value for testPushAndPop.
 * @phpstan-return void
 * @psalm-return void
 * @see self::testPushAndPop()
 * @example /fr/cleanertest/testPushAndPop
 * @category PmaControl
 * @package App
 * @subpackage Controller
 * @author Aurélien LEQUOY <pmacontrol@68koncept.com>
...
/**
 * Handle cleaner test state through `testGetOrderBy`.
 *
 * This action may stream a direct HTTP or CLI response.
 *
 * @return void Returned value for testGetOrderBy.
 * @phpstan-return void
 * @psalm-return void
 * @see self::testGetOrderBy()
 * @example /fr/cleanertest/testGetOrderBy
 * @category PmaControl
 * @package App
 * @subpackage Controller
 * @author Aurélien LEQUOY <pmacontrol@68koncept.com>
