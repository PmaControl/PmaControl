...
| Apache vhost + bootstrap for parallel checkouts (`/pmacontrol-reviews/<hash>/`, `/pmacontrol-worktrees/<branch>/`); one-shot: `sudo php dev/worktree-install.php` | [docs/parallel_worktree_deployments.md](docs/parallel_worktree_deployments.md) |
