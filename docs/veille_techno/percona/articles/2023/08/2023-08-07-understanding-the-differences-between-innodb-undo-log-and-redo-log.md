---
title: Understanding the Differences Between InnoDB Undo Log and Redo Log
source:
  name: Percona Blog
  url: https://www.percona.com/blog/understanding-the-differences-between-innodb-undo-log-and-redo-log/
  post_id: 27262
source_author:
...
published_at: '2023-08-07T12:05:57'
published_at_gmt: '2023-08-07T12:05:57'
modified_at: '2026-03-26T20:29:17'
modified_at_gmt: '2026-03-26T20:29:17'
curator:
...
- mysql
- mysql-and-variants
featured_image_url: https://www.percona.com/wp-content/uploads/2026/03/Differences-Between-InnoDB-Undo-Log-and-Redo-Log.jpeg
image_count: 1
...
Source: [Percona Blog](https://www.percona.com/blog/understanding-the-differences-between-innodb-undo-log-and-redo-log/)

Auteur source: [Arunjith Aravindan](https://www.percona.com/blog/author/arunjith-aravindan/)

Publication: 2023-08-07T12:05:57
...
In InnoDB, the undo log and the redo log are two indispensable components that play a vital role in maintaining data integrity and ensuring transactional consistency. Both logs are crucial in the ACID (Atomicity, Consistency, Isolation, Durability) properties of database systems. Additionally, they are essential for the Multi-Version Concurrency Control (MVCC) mechanism. In this blog … Continued

## Structure detectee

- H2: InnoDB Undo Log
- H3: Code example – InnoDB Undo Log:
- H2: InnoDB Redo Log
- H3: Conclusion

## Images et graphiques reperes

- featured / image: [Understanding the Differences Between InnoDB Undo Log and Redo Log](https://www.percona.com/wp-content/uploads/2026/03/Differences-Between-InnoDB-Undo-Log-and-Redo-Log.jpeg)
