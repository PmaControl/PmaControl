...
{    
    ...
    { 
        ...
        $erreur .= $e->getMessage();
        $erreur .= "</td></tr>";
        $erreur .= "<tr style='background-color:rgb(240,240,240);'><th>Pile</th><td style='background-color:rgb(230,230,230);'>";
        $tableau = $e->getTrace();
        ...
        {
            if ( ($count2!=0) && ($count==0) && ($value["file"] != $e->getFile()) && ($value["file"] != $e->getLine()) )
            {
                $pile .= "#0 -> <b>Fichier</b> : {$e->getFile()} <b>Ligne</b> : {$e->getLine()} \r\n";
                $count++;
            }
            ...
            { 
                ...
                {
                    $pile .= " <b>Fonction</b> ".$value["function"]."\r\n";
                }
