...
if (! empty($data['translate_auto']))
{
	foreach($data['translate_auto'] as $key => $value)
	{
		...
		$tmp3452453[] ='<img src="'.IMG.'country/type1/'.$key.'.gif" width="18" height="12" border="0"> '.I18n::$languages[$key].' ('.$value.')';
	}
...
echo '
<div class="encadre">'.__("Informations:").'<ul>
...
<li>'.__("The source of the translation cannot be updated here ! You have to update it on the source code or from the database.").'</li>
